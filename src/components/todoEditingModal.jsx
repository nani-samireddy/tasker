            ...
            <div className="modal-content">
                ...
                <form onSubmit={handleSave}>
                    ...
                    <div className='form-control'>
                        ...
                        <textarea ref={descriptionRef} id='description' name='description' placeholder='Patch up black holes with quantum algorithms' ></textarea>
                    </div>
                    <div className='form-control'>
                    ...
                    <div className="buttons-container">
                        ...
                        <button type="button" className='button-danger' onClick={handleClose}>Cancel</button>
                    </div>
                </form>
            </div>
        </div>
